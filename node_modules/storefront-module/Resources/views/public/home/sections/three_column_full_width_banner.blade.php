    ...
    <div class="container">
        <div class="row">
            <div class="col-md-4">
                ...
                >
                    <img src="{{ $threeColumnFullWidthBanners['banner_1']->image->path }}" alt="Banner" />
                </a>
            </div>
            ...
            <div class="col-md-10">
                ...
                >
                    <img src="{{ $threeColumnFullWidthBanners['banner_2']->image->path }}" alt="Banner" />
                </a>
            </div>
            ...
            <div class="col-md-4">
                ...
                >
                    <img src="{{ $threeColumnFullWidthBanners['banner_3']->image->path }}" alt="Banner" />
                </a>
            </div>
        </div>
    </div>
